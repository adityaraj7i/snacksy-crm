...
They are used only to seed the first staff accounts. Afterward, the owner can change staff names and PINs from the Staff screen. Never commit the actual PIN values or a local `.env` file.
